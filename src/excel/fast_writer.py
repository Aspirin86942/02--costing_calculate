...
from src.excel.excel_values import (
    ...
    freeze_panes_to_rc,
    is_blank_excel_value,
    resolve_fixed_width,
    write_cell,
)
from src.excel.product_anomaly_writer import (
    build_product_anomaly_sections_from_model,
...
_freeze_panes_to_rc = freeze_panes_to_rc
_is_blank_excel_value = is_blank_excel_value
_resolve_fixed_width = resolve_fixed_width
...
class FastSheetWriter:
    ...
    def write_product_anomaly_sheet(
        ...
        write_product_anomaly_sheet(writer, sheet_name, sections)
    ...
    def apply_work_order_highlights(
        ...
        *,
        ...
        apply_work_order_highlights(workbook, worksheet, columns=columns, max_row=max_row)
